...
Lab 16, in `labs/texel-density/`. Five stages, 12 steps. It shows texel density from three sides: you see it (checker), you compute it (px ÷ m), and you decide it (camera, memory, exceptions).
