...
import { paintSheet, mip } from './paint.js?v=2';
...
import { STAGES, QUIZ, startState, meshOf, layoutInfo, reports } from './stages.js?v=2';
...
function renderHeaders() {
  ...
  $('#pivot-field').hidden = isBoard() || id === 't2' || id === 'p3';
  $('#pivot').value = S.pivot;
